...
# 📖 Air pullution App <a name="about-project"></a>

**[Air pullution App]** This React capstone project is about building a mobile web application to check a list of metrics (numeric values) that were created by making use of React and Redux. An API (OpenWeahter) was chosen to provide numeric data and then build the web app around it.
...
- [video Link](https://www.loom.com/share/a82c7df6ffe24ce1af378c7bc3329284)
...
```sh
  cd my-folder
  git clone https://github.com/yayoamigo/Air-polution-app.git
```
